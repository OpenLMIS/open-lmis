...
public class VaccineReportService {
  ...
  public VaccineReport getById(Long id) {
    ...
    report.setFacilityDemographicEstimates(facilityDemographicEstimateService.getEstimateValuesForFacility(report.getFacilityId(), report.getProgramId(), report.getPeriod().getStartDate().getYear()));
    return report;
  }
