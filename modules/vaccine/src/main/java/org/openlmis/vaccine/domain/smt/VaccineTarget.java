...
public class VaccineTarget  extends BaseModel {
    ...
    private int expectedBirths;
    private int expectedPregnancies;
    private int servingInfants;
    private int survivingInfants;
    private int children1Yr;
    private int children2Yr;
    private int girls9_13Yr;
