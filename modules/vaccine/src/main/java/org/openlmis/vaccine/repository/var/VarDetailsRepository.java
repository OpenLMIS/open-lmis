...
import org.openlmis.vaccine.repository.mapper.var.VarDetailsMapper;
...
@Component
public class VarDetailsRepository {

    @Autowired
    private VarDetailsMapper mapper;
    ...
    public void insert(VarDetails var_details){
        mapper.insert(var_details);
    }
