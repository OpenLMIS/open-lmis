...
public class AnnualFacilityEstimateEntryRepositoryTest {
  ...
  public void shouldInsert() throws Exception {
    AnnualFacilityEstimateEntry estimate = make(a(FacilityDemographicEstimateBuilder.defaultFacilityDemographicEstimate));
