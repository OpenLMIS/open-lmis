...
public class CsvBeanReader {
  ...
  public Importable read() throws IOException {
    return dozerBeanReader.read(modelClass.getClazz());  //To change body of created methods use File | Settings | File Templates.
  }
  ...
  public void configureProcessors() throws IOException {
