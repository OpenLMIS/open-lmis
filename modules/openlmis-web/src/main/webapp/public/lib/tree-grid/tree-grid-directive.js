        ...
        .run([
            ...
            function ($templateCache) {
                $templateCache.put('template/treeGrid/treeGrid.html',
                    ...
                    "           </div>\n" +
                                "<div ng-if='(row.level===3) && viewStockMovementToggle' style='display: inline-block; margin-right: 20px'><a href='#/stock-movements/product/{{product.code}}/facility/{{row.branch.facilityCode}}' openlmis-message='report.view.stock.card'></a> </div>\n" +
                    "           <div " +
