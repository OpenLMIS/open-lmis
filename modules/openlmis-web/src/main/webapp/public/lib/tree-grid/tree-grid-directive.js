        ...
        .run([
            ...
            function ($templateCache) {
                $templateCache.put('template/treeGrid/treeGrid.html',
                    ...
                    "              ng-click=\"expandOrCollapse(row.branch)\"\n" +
                    ...
                    "           </div>\n" +
                                "<div ng-if='(row.level===3) && viewStockMovementToggle' style='display: inline-block; margin-right: 20px'><a href='#/stock-movements/product/{{product.code}}/facility/{{row.branch.facilityCode}}'>{{viewStockCardMessage}}</a> </div>\n" +
                    "           <div " +
            ...
            function ($timeout,
                ...
                return {
                    ...
                    link: function (scope, element, attrs) {
                        ...
                        scope.expandOrCollapse = function (branch) {
