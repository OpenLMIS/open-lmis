...
distributionModule.config(['$routeProvider', function ($routeProvider) {
      $routeProvider.
          ...
          when('/record-facility-data/:distribution/:facility/fullCoverage',
          {controller: CoverageController, templateUrl: 'partials/fullCoverage.html', resolve: ResolveDistribution}).
