  ...
  $scope.gridOptions = { data: 'orders',
    ...
    columnDefs: [
      ...
      {field: 'emergency', displayName: messageService.get("requisition.type.emergency"),
        ...
        width: 90 },
      {cellTemplate: "<div class='ngCellText'><a ng-show=\"row.entity.productsOrdered\" ng-href='/orders/{{row.entity.id}}/download.csv' openlmis-message='link.download.csv'></a> <a ng-show=\"row.entity.productsOrdered\" ng-href='/reports/download/order_summary/PDF?orderId={{row.entity.id}}'>Print</a>" +
