...
function ViewOrderListController($scope, Orders, messageService, $location, $routeParams) {
  ...
  $scope.gridOptions = { data: 'orders',
    ...
    enableSorting: false,
    columnDefs: [
      {field: 'orderNumber', displayName: messageService.get("label.order.no"), width: 70, cellTemplate: "<div class='ngCellText'><span class='orderNumber'>{{row.entity.orderNumber}}</span></div>"},
