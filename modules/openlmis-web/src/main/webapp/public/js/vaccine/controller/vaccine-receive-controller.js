 ...
 */
function VaccineReceiveController($scope,$route,$location,messageService,GetDonors,Products,PushProgramProducts,Manufacturers,VaccineDistributionStatus,VaccineStorageByFacility,GeographicZones,ReceiveVaccines,Countries){
    ...
    Products.get({}, function(data){
       // $scope.products = data.productList;
        //alert('products are '+JSON.stringify($scope.products))
    });
