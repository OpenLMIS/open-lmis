...
function InitiateRnrController($scope, $location, $rootScope, Requisition, PeriodsForFacilityAndProgram, UserFacilityList, hasPermission,
                               UserSupportedProgramInFacilityForAnOperation, UserSupervisedProgramList, UserSupervisedFacilitiesForProgram) {
...
InitiateRnrController.resolve = {
  hasPermission:function (AuthorizationService) {
    AuthorizationService.hasPermission('CREATE_REQUISITION', 'AUTHORIZE_REQUISITION');
  }
};
