...
function ViewRnrController($scope, requisitionData, rnrColumns, regimenTemplate, equipmentOperationalStatus, $location, pageSize, $routeParams, requisitionService) {
