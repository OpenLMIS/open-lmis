function StockImbalanceController($scope, StockImbalanceReport, ReportSchedules, ReportPrograms , Periods , Products ,ReportFacilityTypes,GeographicZones, RequisitionGroups, $http, $routeParams,$location) {
    ...
    $scope.gridOptions = {
        ...
        columnDefs:
            [
                ...
                { field: 'physicalCount', displayName: 'Physical Count', width : "*", cellTemplate: '<div class="ngCellText" style="text-align:right;" ng-class="col.colIndex()"><span ng-cell-text>{{formatNumber(COL_FIELD,"0,000")}}</span></div>'},
                { field: 'amc', displayName: 'AMC', width : "*", cellTemplate: '<div class="ngCellText" style="text-align:right;" ng-class="col.colIndex()"><span ng-cell-text>{{formatNumber(COL_FIELD,"0,000")}}</span></div>'},
                { field: 'months', displayName: 'Months', width : "*", cellTemplate: '<div class="ngCellText" style="text-align:right;" ng-class="col.colIndex()"><span ng-cell-text>{{formatNumber(COL_FIELD,"0,000")}}</span></div>'},
                { field: 'orderQuantity', displayName: 'Order Quantity', width : "*", cellTemplate: '<div class="ngCellText" style="text-align:right;" ng-class="col.colIndex()"><span ng-cell-text>{{formatNumber(COL_FIELD,"0,000")}}</span></div>'},
