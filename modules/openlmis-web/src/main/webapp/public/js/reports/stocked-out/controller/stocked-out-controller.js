function StockedOutController($scope, StockedOutReport, Products , ProductCategories, ReportFacilityTypes, RequisitionGroups,OperationYears,Months, $http, $routeParams,$location) {
