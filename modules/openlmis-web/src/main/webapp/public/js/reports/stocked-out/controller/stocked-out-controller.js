...
function StockedOutController($scope, $window, $filter, ngTableParams, $http, $routeParams, $location, StockedOutReport, ReportProductsByProgram, ProductCategoriesByProgram, ReportPrograms, ReportFacilityTypes, FacilitiesByProgramParams, RequisitionGroupsByProgram, OperationYears, Months) {
