...
import static org.openlmis.web.view.RequisitionFooter.PAGE_TEXT_HEIGHT;
import static org.openlmis.web.view.RequisitionFooter.PAGE_TEXT_WIDTH;
import static org.powermock.api.mockito.PowerMockito.mockStatic;
import static org.powermock.api.mockito.PowerMockito.whenNew;

@RunWith(MockitoJUnitRunner.class)
@Ignore
@PrepareForTest({RequisitionFooter.class, BaseFont.class})
public class RequisitionFooterTest {
  ...
  public void testPrintPageNumberOnEveryPage() throws Exception {
    RequisitionFooter requisitionFooter = new RequisitionFooter();
