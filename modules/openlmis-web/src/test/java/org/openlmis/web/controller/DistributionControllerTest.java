...
public class DistributionControllerTest {
  ...
  public void shouldSyncFacilityDistributionData() {
    ...
    FacilityDistribution facilityDistributionData = new FacilityDistribution(null, null, new DistributionRefrigerators(facility, distribution, EMPTY_LIST), null, null);
