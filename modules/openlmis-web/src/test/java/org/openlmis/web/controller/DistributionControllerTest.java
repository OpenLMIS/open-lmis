...
public class DistributionControllerTest {
  ...
  public void shouldSyncFacilityDistributionData() {
    ...
    FacilityDistribution facilityDistributionData = new FacilityDistribution(null, null, new DistributionRefrigerators(facility, distribution.getId(), EMPTY_LIST), null, null);
