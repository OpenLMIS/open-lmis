...
INSERT INTO alert_summary(
    ...
    VALUES (rec.rec_count, ' Emergency Reuisitions', rec.supervisorynodeid, 'EMERGENCY_REQUISITION', rec.programid);
...
LOOP --fetch the table row inside the loop
  ...
  select id into v_summaryid from alert_summary where programid = rec2.programid and supervisorynodeid = rec2.supervisorynodeid and alerttypeid = 'EMERGENCY_REQUISITION';
