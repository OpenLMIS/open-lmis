...
CREATE OR REPLACE VIEW dw_product_facility_stock_info_vw AS 
 SELECT dw_orders.requisitiongroupid, dw_orders.programid, dw_orders.periodid, dw_orders.productid, products.primaryname, dw_orders.facilityid, dw_orders.facilityname, dw_orders.amc, dw_orders.soh, dw_orders.mos, dw_orders.stocking
   FROM dw_orders
