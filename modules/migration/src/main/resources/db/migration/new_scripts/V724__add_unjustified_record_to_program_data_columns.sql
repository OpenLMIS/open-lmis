DELETE FROM program_data_items WHERE programdatacolumnid IN (SELECT id FROM program_data_columns WHERE code IN ('UNJUSTIFIED_HIVDETERMINE','UNJUSTIFIED_HIVUNIGOLD','UNJUSTIFIED_SYPHILLIS','UNJUSTIFIED_MALARIA'));
