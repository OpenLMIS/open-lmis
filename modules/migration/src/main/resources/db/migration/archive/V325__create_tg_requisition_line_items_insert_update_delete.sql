...
-- Trigger: tg_requisitions_insert_update_delete on requisitions
DROP TRIGGER IF EXISTS tg_requisition_line_items_insert_update_delete ON requisition_line_items;
...
CREATE TRIGGER tg_requisition_line_items_insert_update_delete
