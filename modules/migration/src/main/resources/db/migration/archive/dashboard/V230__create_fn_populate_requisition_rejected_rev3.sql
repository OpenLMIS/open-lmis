...
LOOP
delete from alert_summary where supervisorynodeid = rec_summary.supervisorynodeid and programid = rec_summary.programid and periodid = rec_summary.periodid and alerttypeid = 'REQUISITION_REJECTED';

INSERT INTO alert_summary(
statics_value, description, supervisorynodeid, alerttypeid,
programid,periodid)
VALUES (rec_summary.rec_count, 'Requisitions Rejected', rec_summary.supervisorynodeid, 'REQUISITION_REJECTED', rec_summary.programid, rec_summary.periodid);
...
select id into v_summaryid from alert_summary where supervisorynodeid = rec_detail.supervisorynodeid and programid = rec_detail.programid and  periodid = rec_detail.periodid and alerttypeid = 'REQUISITION_REJECTED';
