...
CREATE OR REPLACE VIEW dw_product_fill_rate_vw AS 
 SELECT dw_orders.geographiczoneid, dw_orders.periodid, dw_orders.facilityid, dw_orders.productid, 
  ...
  GROUP BY dw_orders.geographiczoneid, dw_orders.periodid, dw_orders.facilityid, dw_orders.productid, products.primaryname;
