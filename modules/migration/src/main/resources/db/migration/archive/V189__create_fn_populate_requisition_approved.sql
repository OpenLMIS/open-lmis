...
delete from alert_summary where supervisorynodeid = rec.supervisorynodeid and programid = rec.program_id and alerttypeid = 'ALERT_REQUISITION_APPROVED';
...
INSERT INTO alert_summary(
    ...
    VALUES (rec.rec_count, null, rec.supervisorynodeid, 'ALERT_REQUISITION_APPROVED', rec.programid);
