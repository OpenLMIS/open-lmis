...
/*
  ToDo:
 1. add logic for stockedoutinpast, currently hardcoded to 'N';
 2. add logic for suppliedinpast, currently hardcoded to 'N';
 3. add logic for mossuppliedinpast, currenly hardcoded to 1;
 4. add logic for late reporting
*/
...
requisition_groups.supervisorynodeid as rg_supervisorynodeid
...
INNER JOIN product_categories ON product_categories.id = vw_requisition_detail.categoryid
 ...
 v_supervisorynodeid = rec.rg_supervisorynodeid;
