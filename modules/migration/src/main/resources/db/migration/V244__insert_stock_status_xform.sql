...
(formid,
 ...
 xmlstring,
 active,
 odk_xform_survey_type_id)
  VALUES ('build_Stock-Status_1403568516',
          'Stock Status',
          '1',
          'hash',
          'XForm used to collect commodity stock status.',
          'http://uat.tz.elmis-dev.org/odk-api/getForm/build_Stock-Status_1403568516',
          '<h:html xmlns="http://www.w3.org/2002/xforms" xmlns:h="http://www.w3.org/1999/xhtml" xmlns:ev="http://www.w3.org/2001/xml-events" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:jr="http://openrosa.org/javarosa">
  <h:head>
    <h:title>Stock Status</h:title>
    <model>
      <instance>
        <data id="build_Stock-Status_1403568516">
          <meta>
            <instanceID/>
          </meta>
