...
import org.openlmis.report.builder.helpers.RequisitionPredicateHelper;
...
public class AggregateConsumptionQueryBuilder {
  ...
  public static String getQuery(Map params){
    ...
    RequisitionPredicateHelper.whereProgramFilter();
    RequisitionPredicateHelper.wherePeriodFilter();
    RequisitionPredicateHelper.whereFacilityPermission();
    RequisitionPredicateHelper.whereMultiProductFilter(filter.getProducts());
    RequisitionPredicateHelper.whereProductCategory(filter.getProductCategory());
    RequisitionPredicateHelper.whereGeographicZoneFilter(filter.getZone());
