...
/*
        ...
        SELECT("product productDescription , productcategory category, ft.name facilityType, f.name facilityName, ft.name adjustmentType, li.totallossesandadjustments adjustment, f.name supplyingFacility");
