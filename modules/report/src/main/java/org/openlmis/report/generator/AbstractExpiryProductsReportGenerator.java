...
public abstract class AbstractExpiryProductsReportGenerator extends AbstractReportModelGenerator{
    ...
    protected Map<String, String> getMergedColumns(Map<Object, Object> paraMap) {
