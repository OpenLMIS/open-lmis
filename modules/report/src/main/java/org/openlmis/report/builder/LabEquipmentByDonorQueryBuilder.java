...
public class LabEquipmentByDonorQueryBuilder {
    ...
    public static String SelectFilteredSortedPagedRecords(Map params){
        ...
        StringBuilder query = new StringBuilder();
            query.append("select * from vw_equipment_list_by_donor")
    ...
    private static String writePredicates(Map params, Long userId){
        ...
        String equipmentTypeId = StringHelper.isBlank(params,("equipmentType"))  ? null :((String[])params.get("equipmentType"))[0];
