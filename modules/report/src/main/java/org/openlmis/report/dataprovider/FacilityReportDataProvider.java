...
public class FacilityReportDataProvider extends ReportDataProvider {
    ...
    private ReportData getFacilityReport(Facility facility){
        ...
        return new FacilityReport(facility.getCode(),facility.getName(),facility.getFacilityType() != null ? facility.getFacilityType().getName() : null,facility.getActive(),facility.getAddress1(),facility.getOperatedBy() != null ? facility.getOperatedBy().getText() : null ,facility.getLongitude().toString(),facility.getLatitude().toString(),facility.getAltitude().toString(),null,facility.getMainPhone(),null,null);
    }
