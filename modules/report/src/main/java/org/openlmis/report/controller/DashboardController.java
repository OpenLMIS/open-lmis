...
public class DashboardController extends BaseController {
    ...
    @RequestMapping(value = "/requisitionGroup/{rgroupId}/program/{programId}/period/{periodId}/product/{productId}/stockedOutFacilities", method = GET, headers = BaseController.ACCEPT_JSON)
    ...
    @RequestMapping(value = "/alerts", method = GET, headers = BaseController.ACCEPT_JSON)
