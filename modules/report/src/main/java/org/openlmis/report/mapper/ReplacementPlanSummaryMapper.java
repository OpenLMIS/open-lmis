...
import org.openlmis.report.builder.vaccineReport.ReplacementPlanSummaryQueryBuilder;
...
public interface ReplacementPlanSummaryMapper {
    ...
    public List<ReplacementPlanSummary> getReport(Map params, @Param("RowBounds") RowBounds rowBounds);
