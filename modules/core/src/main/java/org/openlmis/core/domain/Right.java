...
public enum Right {
  ...
  MANAGE_USERS("right.manage.user", ADMIN, "Permission to manage users(crud)", 7),
  UPLOADS("right.upload", ADMIN, "Permission to upload", 8),
  VIEW_REPORTS("right.view.report", ADMIN, "Permission to view reports", 11),
  MANAGE_REPORTS("right.manage.report", ADMIN, "Permission to manage reports", 10, VIEW_REPORTS),
