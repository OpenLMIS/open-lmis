...
public class FacilityRepositoryTest {
    ...
    public void shouldUpdateSupportedProgramsForFacilityIfIdIsDefined() throws Exception {
        ...
        verify(programSupportedMapper).addSupportedProgram(new ProgramSupported(facility.getId(), 1, true, facility.getModifiedBy(), facility.getModifiedDate()));
        verify(programSupportedMapper).deleteObsoletePrograms(facility.getId(), 2);
    }
