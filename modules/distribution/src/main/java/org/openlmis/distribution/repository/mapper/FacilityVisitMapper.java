...
public interface FacilityVisitMapper {
  ...
  @Insert({"INSERT INTO facility_visits (distributionId, facilityId, synced, visited, createdBy, modifiedBy)",
    "VALUES (#{distributionId}, #{facilityId}, #{synced}, #{visited},  #{createdBy}, #{modifiedBy})"})
