...
public class VaccinationCoverageDTOTest {
  ...
  public void shouldTransformCoverageDTOIntoCoverage() throws Exception {
    ...
    VaccinationCoverageDTO coverageDTO = new VaccinationCoverageDTO(123L, 234L, femaleHealthCenterReading, femaleMobileBrigadeReading, maleHealthCenterReading, maleMobileBrigadeReading);

    coverageDTO.transform();
