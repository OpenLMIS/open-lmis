...
public class EpiUseMapperIT {
  ...
  public void shouldSaveEpiUseLineItem() throws Exception {
    ...
    EpiUseLineItem epiUseLineItem = new EpiUseLineItem(facilityVisit.getId(), productGroup, facilityVisit.getCreatedBy(), facilityVisit.getModifiedBy());
  ...
  public void shouldGetEpiUseLineItemsByFacilityVisitId() {
    ...
    EpiUseLineItem epiUseLineItem1 = new EpiUseLineItem(facilityVisit.getId(), productGroup, facilityVisit.getCreatedBy(), facilityVisit.getModifiedBy());
    ...
    EpiUseLineItem epiUseLineItem2 = new EpiUseLineItem(facilityVisit.getId(), productGroup2, facilityVisit.getCreatedBy(), facilityVisit.getModifiedBy());
