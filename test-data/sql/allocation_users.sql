...
INSERT INTO roles
 ...
 INSERT INTO users
  ...
  ('FieldCoordinator', 'Agismyf1Whs0fxr1FFfK8cs3qisVJ1qMs3yuMLDTeEcZEGzstjiswaaUsQNQTIKk1U5JRzrDbPLCzCO1isvB5YGaEQieie', (SELECT id FROM vendors WHERE name = 'openLmis'), (SELECT id FROM facilities WHERE code = 'F10'), 'Field', 'Coordinator','fieldcoordinator@openlmis.com', true, true);
 ...
 INSERT INTO role_assignments
  ...
  ((SELECT id FROM USERS WHERE username='superuser'), (SELECT id FROM roles WHERE name = 'FieldCoordinator'), (SELECT id FROM delivery_zones WHERE code='Norte'), (SELECT id FROM programs WHERE name = 'VACCINES')),
  ((SELECT id FROM USERS WHERE username='superuser'), (SELECT id FROM roles WHERE name = 'FieldCoordinator'), (SELECT id FROM delivery_zones WHERE code='Centro'), (SELECT id FROM programs WHERE name = 'VACCINES')),
  ((SELECT id FROM USERS WHERE username='superuser'), (SELECT id FROM roles WHERE name = 'FieldCoordinator'), (SELECT id FROM delivery_zones WHERE code='Sul'), (SELECT id FROM programs WHERE name = 'VACCINES')),
