...
(13, (select id from programs where code = 'TB'), false, 'C', 13, 'Adjusted Total Consumption'),
(14, (select id from programs where code = 'TB'), false, 'C', 14, 'Average Monthly Consumption(AMC)'),
(15, (select id from programs where code = 'TB'), false, 'C', 15, 'Maximum Stock Quantity'),
(16, (select id from programs where code = 'TB'), true, 'C',  16, 'Calculated Order Quantity'),
(17, (select id from programs where code = 'TB'), true, 'U',  17, 'Requested Quantity'),
(18, (select id from programs where code = 'TB'), true, 'U',  18, 'Requested Quantity Explanation'),
(19, (select id from programs where code = 'TB'), false, 'U', 19, 'Approved Quantity'),
(20, (select id from programs where code = 'TB'), false, 'C', 20, 'Packs to Ship'),
(21, (select id from programs where code = 'TB'), false, 'R', 21, 'Price per Pack'),
(22, (select id from programs where code = 'TB'), false, 'C', 22, 'Total Cost'),
(23, (select id from programs where code = 'TB'), false, 'U', 23, 'Expiration Date(MM/YYYY)'),
(24, (select id from programs where code = 'TB'), false, 'U', 24, 'Remarks'),
