...
(8, (select id from programs where code = 'HIV'),  true, 'U', 8,  'Reason for Losses and Adjustments'),
(9, (select id from programs where code = 'HIV'),  true, 'C', 9,  'Stock on Hand'),
(10, (select id from programs where code = 'HIV'), true, 'U', 10, 'Total number of new patients added to service on the program'),
