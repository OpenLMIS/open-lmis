...
-- User=postgres, Schema=public, URL=jdbc:postgresql://localhost:5432/open_lmis_baseseed
-- 
-- to match the data from: 
-- User=postgres, Schema=public, URL=jdbc:postgresql://localhost:5432/open_lmis_demoseed
-- 
-- Tables included:
-- public.adult_coverage_opened_vial_line_items
-- public.alert_facility_stockedout
-- public.alert_requisition_approved
-- public.alert_requisition_emergency
-- public.alert_requisition_pending
-- public.alert_requisition_rejected
-- public.alert_stockedout
-- public.alert_summary
-- public.alerts
-- public.budget_configuration
-- public.budget_file_columns
-- public.budget_file_info
-- public.budget_line_items
-- public.child_coverage_opened_vial_line_items
-- public.comments
-- public.configurable_rnr_options
-- public.configuration_settings
-- public.coverage_product_vials
-- public.coverage_target_group_products
-- public.custom_reports
-- public.delivery_zone_members
-- public.delivery_zone_program_schedules
-- public.delivery_zone_warehouses
-- public.delivery_zones
-- public.demographic_estimate_categories
-- public.distributions
-- public.district_demographic_estimates
-- public.donors
-- public.dosage_frequencies
-- public.dosage_units
-- public.dw_orders
-- public.elmis_help
-- public.elmis_help_document
-- public.elmis_help_topic
-- public.elmis_help_topic_roles
-- public.email_attachments
-- public.email_attachments_relation
-- public.email_notifications
-- public.emergency_requisitions
-- public.epi_inventory_line_items
-- public.epi_use_line_items
-- public.equipment_cold_chain_equipment_designations
-- public.equipment_cold_chain_equipment_pqs_status
-- public.equipment_cold_chain_equipments
-- public.equipment_contract_service_types
-- public.equipment_energy_types
-- public.equipment_inventories
-- public.equipment_inventory_statuses
-- public.equipment_maintenance_logs
-- public.equipment_maintenance_requests
-- public.equipment_operational_status
-- public.equipment_service_contract_equipment_types
-- public.equipment_service_contract_facilities
-- public.equipment_service_contracts
-- public.equipment_service_types
-- public.equipment_service_vendor_users
-- public.equipment_service_vendors
-- public.equipment_status_line_items
-- public.equipment_type_products
-- public.equipment_type_programs
-- public.equipment_types
-- public.equipments
-- public.facilities
-- public.facility_approved_products
-- public.facility_demographic_estimates
-- public.facility_ftp_details
-- public.facility_mappings
-- public.facility_operators
-- public.facility_program_products
-- public.facility_types
-- public.facility_visits
-- public.fulfillment_role_assignments
-- public.full_coverages
-- public.geographic_levels
-- public.geographic_zone_geojson
-- public.geographic_zones
-- public.gtin_lookups
-- public.interface_apps
-- public.interface_dataset
-- public.isa_coefficients
-- public.losses_adjustments_types
-- public.lots
-- public.lots_on_hand
-- public.manufacturers
-- public.master_regimen_columns
-- public.master_rnr_column_options
-- public.master_rnr_columns
-- public.mos_adjustment_basis
-- public.mos_adjustment_facilities
-- public.mos_adjustment_products
-- public.mos_adjustment_types
-- public.order_configuration
-- public.order_file_columns
-- public.order_number_configuration
-- public.order_quantity_adjustment_factors
-- public.order_quantity_adjustment_products
-- public.order_quantity_adjustment_types
-- public.orders
-- public.patient_quantification_line_items
-- public.period_short_names
-- public.pod
-- public.pod_line_items
-- public.price_schedules
-- public.processing_periods
-- public.processing_schedules
-- public.product_categories
-- public.product_forms
-- public.product_groups
-- public.product_price_schedules
-- public.product_short_names
-- public.products
-- public.program_product_price_history
-- public.program_products
-- public.program_regimen_columns
-- public.program_rnr_columns
-- public.programs
-- public.programs_supported
-- public.refrigerator_problems
-- public.refrigerator_readings
-- public.refrigerators
-- public.regimen_categories
-- public.regimen_combination_constituents
-- public.regimen_constituents_dosages
-- public.regimen_line_items
-- public.regimen_product_combinations
-- public.regimens
-- public.report_rights
-- public.requisition_group_members
-- public.requisition_group_program_schedules
-- public.requisition_groups
-- public.requisition_line_item_losses_adjustments
-- public.requisition_line_items
-- public.requisition_signatures
-- public.requisition_status_changes
-- public.requisitions
-- public.rights
-- public.role_assignments
-- public.role_rights
-- public.roles
-- public.shipment_configuration
-- public.shipment_file_columns
-- public.shipment_file_info
-- public.shipment_line_items
-- public.signatures
-- public.sms
-- public.stock_adjustment_reasons_programs
-- public.stock_card_entries
-- public.stock_card_entry_key_values
-- public.stock_cards
-- public.stock_movement_line_item_extra_fields
-- public.stock_movement_line_items
-- public.stock_movement_lots
-- public.stock_movements
-- public.supervisory_nodes
-- public.supply_lines
-- public.template_parameters
-- public.templates
-- public.user_password_reset_tokens
-- public.user_preference_master
-- public.user_preference_roles
-- public.user_preferences
-- public.users
-- public.vaccination_adult_coverage_line_items
-- public.vaccination_child_coverage_line_items
-- public.vaccine_discarding_reasons
-- public.vaccine_diseases
-- public.vaccine_distribution_line_item_lots
-- public.vaccine_distribution_line_items
-- public.vaccine_distributions
-- public.vaccine_doses
-- public.vaccine_inventory_product_configurations
-- public.vaccine_ivd_tab_visibilities
-- public.vaccine_ivd_tabs
-- public.vaccine_logistics_master_columns
-- public.vaccine_lots_on_hand_adjustments
-- public.vaccine_lots_on_hand_vvm
-- public.vaccine_order_requisition_line_items
-- public.vaccine_order_requisition_master_columns
-- public.vaccine_order_requisition_status_changes
-- public.vaccine_order_requisitions
-- public.vaccine_product_doses
-- public.vaccine_program_logistics_columns
-- public.vaccine_report_adverse_effect_line_items
-- public.vaccine_report_campaign_line_items
-- public.vaccine_report_cold_chain_line_items
-- public.vaccine_report_coverage_line_items
-- public.vaccine_report_disease_line_items
-- public.vaccine_report_logistics_line_items
-- public.vaccine_report_status_changes
-- public.vaccine_report_vitamin_supplementation_line_items
-- public.vaccine_reports
-- public.vaccine_vitamin_supplementation_age_groups
-- public.vaccine_vitamins
-- public.var_details
-- public.var_item_alarms
-- public.var_item_partials
-- public.var_items
-- public.dw_order_fill_rate_vw
-- public.dw_product_facility_stock_info_vw
-- public.dw_product_fill_rate_vw
-- public.dw_product_lead_time_vw
-- public.vw_cce_repair_management
-- public.vw_cce_repair_management_not_functional
-- public.vw_cold_chain_equipment
-- public.vw_district_financial_summary
-- public.vw_districts
-- public.vw_e2e_stock_status
-- public.vw_equipment_list_by_donor
-- public.vw_expected_facilities
-- public.vw_facility_requisitions
-- public.vw_lab_equipment_status
-- public.vw_order_fill_rate
-- public.vw_program_facility_supplier
-- public.vw_regimen_district_distribution
-- public.vw_replacement_plan_summary
-- public.vw_requisition_adjustment
-- public.vw_requisition_detail
-- public.vw_requisition_detail_dw
-- public.vw_rnr_feedback
-- public.vw_rnr_status
-- public.vw_rnr_status_details
-- public.vw_stock_cards
-- public.vw_stock_status
-- public.vw_stock_status_2
-- public.vw_supply_status
-- public.vw_timeliness_report
-- public.vw_user_districts
-- public.vw_user_facilities
-- public.vw_user_geographic_zones
-- public.vw_user_role_assignments
-- public.vw_user_supervisorynodes
-- public.vw_vaccine_campaign
-- public.vw_vaccine_cold_chain
-- public.vw_vaccine_coverage
-- public.vw_vaccine_disease_surveillance
-- public.vw_vaccine_district_target_population
-- public.vw_vaccine_estimates
-- public.vw_vaccine_iefi
-- public.vw_vaccine_stock_status
-- public.vw_vaccine_target_population
-- public.vw_vaccine_vitamin_supplementation
-- 
-- Generated by SQL Workbench/J at: 2016-02-05 13:37:10.413 PST
-- **********************************************************************************
