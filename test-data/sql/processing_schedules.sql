...
('Period1', 'first period',  '2012-12-01', '2013-01-15', 2, (SELECT id FROM processing_schedules LIMIT 1), (SELECT id FROM users LIMIT 1)),
('Period2', 'second period', '2013-01-16', '2013-04-30', 3, (SELECT id FROM processing_schedules LIMIT 1), (SELECT id FROM users LIMIT 1));