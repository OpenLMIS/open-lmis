...
('P100','a','Glaxo and Smith','a','a','a','a','antibiotic','antibiotic','TDF/FTC/EFV','TDF/FTC/EFV','TDF/FTC/EFV','TDF/FTC/EFV','300/200/600',2,1,'Strip',3,1,30,3,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,2.2,2,2,2,2,2,2,2,2,2,'a','a',TRUE,TRUE,TRUE,1,FALSE,TRUE),
('P101','a','Glaxo and Smith','a','a','a','a','antibiotic','antibiotic','TDF/FTC/EFV','TDF/FTC/EFV','TDF/FTC/EFV','TDF/FTC/EFV','300/200/600',2,1,'Strip',3,1,30,3,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,2.2,2,2,2,2,2,2,2,2,2,'a','a',TRUE,TRUE,TRUE,1,FALSE,TRUE),
('P102','a','Glaxo and Smith','a','a','a','a','antibiotic','antibiotic','TDF/FTC/EFV','TDF/FTC/EFV','TDF/FTC/EFV','TDF/FTC/EFV','300/200/600',2,1,'Strip',3,1,30,3,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,2.2,2,2,2,2,2,2,2,2,2,'a','a',TRUE,TRUE,TRUE,1,FALSE,TRUE);
insert into program_product(program_id, product_id, doses_per_month, active) values
(1, 1, 30, true),
(1, 2, 30, true),
(1, 3, 30, true);
