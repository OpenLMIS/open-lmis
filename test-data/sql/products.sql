...
delete from product;
insert into product (id, code,alternate_item_code,manufacturer,manufacturer_code,manufacturer_barcode,moh_barcode,gtin,type,primary_name,full_name,generic_name,alternate_name,description,strength,form_id,dosage_unit_id,dispensing_unit,doses_per_dispensing_unit,doses_per_day,pack_size,alternate_pack_size,store_refrigerated,store_room_temperature,hazardous,flammable,controlled_substance,light_sensitive,approved_by_who,contraceptive_cyp,pack_length,pack_width,pack_height,pack_weight,packs_per_carton,carton_length,carton_width,carton_height,cartons_per_pallet,expected_shelf_life,special_storage_instructions,special_transport_instructions,active,full_supply,tracer,pack_rounding_threshold,round_to_zero,archived) values
