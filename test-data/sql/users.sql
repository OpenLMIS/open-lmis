...
INSERT INTO USERS
(id, userName, password, facilityId, firstName, lastName, verified, active) VALUES
(700, 'commTrack', 'Agismyf1Whs0fxr1FFfK8cs3qisVJ1qMs3yuMLDTeEcZEGzstjiswaaUsQNQTIKk1U5JRzrDbPLCzCO1isvB5YGaEQieie',
 (SELECT id FROM facilities WHERE code = 'F10'), 'CommTrack', 'Doe', TRUE, TRUE);
...
((SELECT ID FROM USERS WHERE username = 'StoreInCharge'), (SELECT id FROM roles WHERE name =
...
((SELECT ID FROM USERS WHERE username = 'StoreInCharge'), (SELECT id FROM roles WHERE name =
                                                                                      'Store In-Charge'), 4, (SELECT
                                                                                                                id FROM
                                                                                                                     supervisory_nodes WHERE
  code = 'N3')),
((SELECT ID FROM USERS WHERE username = 'StoreHead'), (SELECT id FROM roles WHERE name = 'Store In-Charge'), 1, (SELECT
                                                                                                                   id FROM
                                                                                                                        supervisory_nodes WHERE
  code = 'N3')),
((SELECT ID FROM USERS WHERE username = 'FacilityInCharge'), (SELECT id FROM roles WHERE name =
                                                                                         'FacilityHead'), 1, (SELECT
                                                                                                                id FROM
                                                                                                                     supervisory_nodes WHERE
  code = 'N3')),
((SELECT ID FROM USERS WHERE username = 'FacilityHead'), (SELECT id FROM roles WHERE name = 'FacilityHead'), 3, (SELECT
                                                                                                                   id FROM
                                                                                                                        supervisory_nodes WHERE
  code = 'N2')),
((SELECT ID FROM USERS WHERE username = 'FacilityHead'), (SELECT id FROM roles WHERE name = 'FacilityHead'), 2, (SELECT
                                                                                                                   id FROM
                                                                                                                        supervisory_nodes WHERE
  code = 'N2')),
((SELECT ID FROM USERS WHERE username = 'FacilityHead'), (SELECT id FROM roles WHERE name = 'FacilityHead'), 4, (SELECT
                                                                                                                   id FROM
                                                                                                                        supervisory_nodes WHERE
  code = 'N2')),
((SELECT ID FROM USERS WHERE username = 'FacilityHead'), (SELECT id FROM roles WHERE name = 'FacilityHead'), 2, (SELECT
...
((SELECT ID FROM USERS WHERE username = 'FacilityHead'), (SELECT id FROM roles WHERE name = 'FacilityHead'), 4, (SELECT
                                                                                                                   id FROM
                                                                                                                        supervisory_nodes WHERE
  code = 'N3')),
((SELECT ID FROM USERS WHERE username = 'MedicalOfficer'), (SELECT id FROM roles WHERE name =
...
((SELECT ID FROM USERS WHERE username = 'MedicalOfficer'), (SELECT id FROM roles WHERE name =
                                                                                       'Medical-Officer'), 4, (SELECT
                                                                                                                 id FROM
                                                                                                                      supervisory_nodes WHERE
  code = 'N3')),
((SELECT ID FROM USERS WHERE username = 'superuser'), (SELECT id FROM roles WHERE name = 'Medical-Officer'), 4, (SELECT
                                                                                                                   id FROM
                                                                                                                        supervisory_nodes WHERE
  code = 'N1')),
((SELECT ID FROM USERS WHERE username = 'superuser'), (SELECT id FROM roles WHERE name = 'Medical-Officer'), 4, (SELECT
...
((SELECT ID FROM USERS WHERE username = 'superuser'), (SELECT id FROM roles WHERE name = 'Medical-Officer'), 4, (SELECT
                                                                                                                   id FROM
                                                                                                                        supervisory_nodes WHERE
  code = 'N3')),
((SELECT ID FROM USERS WHERE username = 'superuser'), (SELECT id FROM roles WHERE name = 'Medical-Officer'), 3, (SELECT
                                                                                                                   id FROM
                                                                                                                        supervisory_nodes WHERE
  code = 'N1')),
((SELECT ID FROM USERS WHERE username = 'superuser'), (SELECT id FROM roles WHERE name = 'Medical-Officer'), 2, (SELECT
                                                                                                                   id FROM
                                                                                                                        supervisory_nodes WHERE
  code = 'N1')),
((SELECT ID FROM USERS WHERE username = 'superuser'), (SELECT id FROM roles WHERE name = 'Medical-Officer'), 2, (SELECT
...
((SELECT ID FROM USERS WHERE username = 'superuser'), (SELECT id FROM roles WHERE name = 'Medical-Officer'), 2, (SELECT
                                                                                                                   id FROM
                                                                                                                        supervisory_nodes WHERE
  code = 'N3')),
((SELECT ID FROM USERS WHERE username = 'lmu'), (SELECT id FROM roles WHERE name = 'LMU'), 3, (SELECT id FROM
                                                                                                           supervisory_nodes WHERE
  code = 'N1')),
((SELECT ID FROM USERS WHERE username = 'lmu'), (SELECT id FROM roles WHERE name = 'LMU'), 2, (SELECT id FROM
                                                                                                           supervisory_nodes WHERE
  code = 'N1')),
((SELECT ID FROM USERS WHERE username = 'lmu'), (SELECT id FROM roles WHERE name = 'LMU'), 4, (SELECT id FROM
                                                                                                           supervisory_nodes WHERE
  code = 'N1')),
((SELECT ID FROM USERS WHERE username = 'lmu'), (SELECT id FROM roles WHERE name = 'LMU'), 2, (SELECT id FROM
                                                                                                           supervisory_nodes WHERE
...
((SELECT ID FROM USERS WHERE username = 'lmu'), (SELECT id FROM roles WHERE name = 'LMU'), 4, (SELECT id FROM
                                                                                                           supervisory_nodes WHERE
  code = 'N3')),
((SELECT ID FROM USERS WHERE username = 'superuser'), (SELECT id FROM roles WHERE name = 'LMU'), 4, (SELECT id FROM
                                                                                                                 supervisory_nodes WHERE
  code = 'N1')),
((SELECT ID FROM USERS WHERE username = 'superuser'), (SELECT id FROM roles WHERE name = 'LMU'), 3, (SELECT id FROM
                                                                                                                 supervisory_nodes WHERE
  code = 'N1')),
((SELECT ID FROM USERS WHERE username = 'superuser'), (SELECT id FROM roles WHERE name = 'LMU'), 2, (SELECT id FROM
                                                                                                                 supervisory_nodes WHERE
  code = 'N1')),
((SELECT ID FROM USERS WHERE username = 'superuser'), (SELECT id FROM roles WHERE name = 'LMU'), 2, (SELECT id FROM
                                                                                                                 supervisory_nodes WHERE
...
((SELECT ID FROM USERS WHERE username = 'superuser'), (SELECT id FROM roles WHERE name = 'LMU In-Charge'), (SELECT
                                                                                                              id FROM
                                                                                                                   facilities WHERE
  code = 'F10')),
((SELECT ID FROM USERS WHERE username = 'superuser'), (SELECT id FROM roles WHERE name = 'Shipment'), (SELECT id FROM
                                                                                                                   facilities WHERE
  code = 'F11')),
((SELECT ID FROM USERS WHERE username = 'lmuincharge'), (SELECT id FROM roles WHERE name = 'LMU In-Charge'), (SELECT
                                                                                                                id FROM
                                                                                                                     facilities WHERE
  code = 'F10')),
